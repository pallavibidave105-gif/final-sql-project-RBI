...
Project Phase-1(DQDATCISTD{PDACD})
Shalini Verma
•
Jun 16, 2025 (Edited Oct 25, 2025)
500 points
Due Oct 30, 2025, 11:59 PM
📌 Project Submission Phase-1
(Database Queries, Database Analysis, Tables Create, Insert, Select, Truncate, Drop with Documentation, Attributes, Constraints, Datatypes)

⏳ Late Submission Penalty:
100 points will be deducted for late submissions.

🔰 Objective
Design and implement a unique database system for your project. Showcase your understanding of database management concepts by creating a comprehensive system with detailed tables, queries, and documentation.

📝 Phase-1 Task Details

1️⃣ Pick Your Unique Database Theme
- Choose a real-world domain for your database (e.g., Library Management, E-Commerce, Inventory Management, Hospital Management, Educational Portal, Banking System, Social Media, Electricity Department, etc.).
- Action Required: Comment your selected theme on the classroom & whatsapp group to ensure no duplication among peers.

2️⃣ Database Design & Creation
- Create your database using SQL.
- Name it appropriately based on your chosen theme (e.g., EduPortalDB, EcomDB).

3️⃣ Create 25 Tables with Attributes, Datatypes, and Constraints
- Each table must have at least 10 attributes.
- Apply meaningful validations and constraints:
    PRIMARY KEY, FOREIGN KEY (to connect tables logically), NOT NULL, UNIQUE, CHECK (validation rules), DEFAULT values
- Ensure normalization to avoid redundancy.

4️⃣ Insert Proper Records
- Populate each table with at least 20 records.
- Insert realistic and logically connected data.
- Example: In an E-Commerce DB, CustomerID in Orders table must exist in the Customers table.

5️⃣ Write and Execute All Possible Queries
- Demonstrate variety of SQL queries:
1. Database Queries
2. Basic Table Queries as  - Create, Insert, Select , Truncate and Drop

6️⃣ Show Data from Tables
Run SELECT * FROM TableName; queries to display inserted records.
Provide screenshots of query outputs in documentation.

7️⃣ Documentation Requirements
Prepare a well-structured document (README.md in Phase-1 folder) including:

Introduction:
Brief about the chosen domain and its real-world application.

Database Design:
- List of tables with attributes, datatypes, and constraints.
- ER Diagram showing relationships between tables.

Queries:
- SQL code for all DDL, DML, and DQL operations.
- Screenshots of executed queries & results.

Analysis:
- Practical examples of how your database solves real-world problems.

Reflection:
Challenges faced & solutions implemented.

8️⃣ Submission Guidelines
- Submit the following inside Phase-1 folder:
- ProjectPhase1_[YourName]_[DatabaseTheme].sql → SQL scripts for creating and populating the database.
- README.md → Documentation with introduction, tables, queries, ER diagram, results, and analysis.

✅ Grading Criteria
Criteria                                       Weight
Database Design                          30%
Query Implementation                40%
Data Population                          15%
Documentation                           15%


🔥 Pro Tips to Ace the Project

💡 Dream Big: Choose a theme that excites you and reflects your interests.
💡 Plan Thoroughly: Design your tables and ER diagram before coding.
💡 Test Everything: Run all queries to check correctness.
💡 Stay Professional: Write clean SQL scripts and detailed documentation.

This is your chance to showcase creativity + technical skills. Make your database realistic, scalable, and professional.
4 class comments

Chaudhary Shoaib • Sep 15, 2025
NETFLIX

Yusuf Siddiqui • Sep 15, 2025
Film_Industry.

Sneha Mourya • Sep 15, 2025
NASA

Sai Keella • Sep 15, 2025
...
Your work
Turned in
ProjectPhase1_[Pallavi]_[RBI_Database].sql
SQL
...
-- 20. Drop column status (⚠️ Only if no longer needed):
ALTER TABLE Credit_Card_Transaction
DROP COLUMN status;
-- 11. ATM
